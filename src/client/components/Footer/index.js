    ...
    <div className="mx-auto px-6  sm:pr-20 sm:pl-20 pt-6 bg-gray-50">
      <div className="flex flex-col sm:flex-row ">
        <div className="w-full sm:w-1/3 text-center sm:text-left pt-8">
          <h6 className="font-raleway font-bold text-base pb-5">Links</h6>
        ...
        <div className="w-full sm:w-1/3 text-center sm:text-left pt-8 xl:pl-20">
          <h6 className="font-raleway font-bold text-base pb-5">Connect with us</h6>
        ...
        <div className="w-full sm:w-1/3 text-center sm:text-left  pt-8 xl:pl-20">
          <h6 className="font-raleway font-bold text-base pb-5">Our Locations</h6>
          <div className="leading-tight pb-3">
      ...
      <p className="pt-10 pb-5 text-center font-raleway text-xs font-light"> @ Copyright 2019</p>
    </div>
  );
};
