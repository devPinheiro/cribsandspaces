           ...
           <Header />
               <div className="xl:flex lg:flex block mb-4">
                    <div className="block xl:flex-1 lg:flex-1  text-dark  ">
                        ...
                        <div className="pt-8 xl:pt-24 xl:mt-18 xl:pr-10  lg:pt-24 lg:mt-18 lg:pr-10 ">
                            <h1 className="font-raleway leading-tight sm:text-3xl md:text-3xl lg-text-4xl xl:text-4xl text-2xl">
                            Interior Design Beyond Borders
                            </h1>
                            <h6 className="font-raleway text-base sm:text-lg md:text-lg pt-4 pb-12 text-dark-400 ">
...
We turn your space into a wonder
                            ...
                            <div className="flex text-center xl:text-left lg:text-left mb-8 ">
                                <Link
                                    to="/projects"
                                    className="font-raleway text-sm md:text-base lg:text-lg xl:text-lg px-4 py-2 pt-3 pb-3  xl:pt-4 xl:pb-4 lg:pt-4 lg:pb-4 pr-10 pl-10 xl:pr-20 xl:pl-20 lg:pr-16 lg:pl-16 md:pr-10 md:pl-10 border-500 rounded text-white border border-orange-500 bg-orange-500 mt-4 shadow-lg"
                                > 
                                    Explore Now
                                </Link>
                            </div>
